...
SRC_URI_append += " \
    ...
    ${@base_conditional("RZG2_SECURITY_FEATURE", "ENABLE", "file://0003-arm-plat-rzg-Update-Secure-IP-driver.patch", "",d)} \
    ${@base_conditional("RZG2_SECURITY_FEATURE", "ENABLE", "file://0004-core-arm-rzg-add-RPC-driver-support.patch", "",d)} \
    ${@base_conditional("RZG2_SECURITY_FEATURE", "ENABLE", "file://0005-core-arm-rzg-add-PTA-for-Firmware-Update-feature.patch", "",d)} \
"
